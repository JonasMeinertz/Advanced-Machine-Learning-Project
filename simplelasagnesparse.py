...
def train_simple(learning_rate=0.01, n_epochs=200, nkerns=[50, 50], batch_size=128):
    ...
    print xrange(n_valid_batches)

    print '... building the model'

    layer0_flat = lasagne.layers.InputLayer(shape=(batch_size, 69 * 130))
    layer0_input = lasagne.layers.ReshapeLayer(layer0_flat, (batch_size, 1, 69, 130))
    ...
    layer0_pool = lasagne.layers.MaxPool2DLayer(layer0, pool_size=(1, 3))
    ...
    layer1_pool = lasagne.layers.MaxPool2DLayer(layer1, pool_size=(1, 4))
